...
std::shared_ptr<Core::Mesh> ResourcesService::GetMesh(const std::string &path) {
    ...
    for (rapidjson::SizeType i = 0; i < vertsJson.Size(); i++) {
        ...
        vertices.push_back({glm::vec3(static_cast<float>(vert[0].GetFloat()), static_cast<float>(vert[1].GetFloat()),
                                      static_cast<float>(vert[2].GetFloat())),
                            glm::vec3(static_cast<float>(vert[3].GetFloat()), static_cast<float>(vert[4].GetFloat()),
                                      static_cast<float>(vert[5].GetFloat())),
